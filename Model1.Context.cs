...
namespace ComputerServiceManager
{
    ...
    public partial class ComputerServiceManagerEntities : DbContext
    {
        public ComputerServiceManagerEntities()
            : base("name=ComputerServiceManagerEntities")
        {
        }
        ...
        public virtual DbSet<Платеж> Платеж { get; set; }
        ...
        public virtual DbSet<СоставЗаказа_Материалы> СоставЗаказа_Материалы { get; set; }
        public virtual DbSet<СоставЗаказа_Услуги> СоставЗаказа_Услуги { get; set; }
        public virtual DbSet<СпособОплаты> СпособОплаты { get; set; }
        ...
        public virtual DbSet<ТипСтатуса> ТипСтатуса { get; set; }
        public virtual DbSet<ТипУстройства> ТипУстройства { get; set; }
